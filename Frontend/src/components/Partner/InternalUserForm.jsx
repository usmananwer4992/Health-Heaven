...
const InternalUserForm = ({
  ...
  if (typeof id !== "undefined" && userData?.email) {
    initialValues = {
          ...
          <div className="form-group">
            ...
            <div className="controls">
              <input
                ...
                placeholder="Enter internal user email"
          ...
          <div className="form-group">
            ...
            <div className="controls">
              <input
                ...
                name="password"
                className="form-control"
                placeholder="Enter internal user password"
          ...
          <div className="form-group">
            ...
            <div className="controls">
              <input
                ...
                placeholder="Enter internal user repeat password"
                onChange={formik.handleChange}
                onBlur={(e) => {
                  formik.handleBlur(e);
