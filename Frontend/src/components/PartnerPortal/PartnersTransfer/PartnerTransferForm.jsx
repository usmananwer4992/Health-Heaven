          ...
          return commonSchema
            .keys({
              ...
              providerName: Joi.string().required().messages({
                "string.base": "Provider Name should be a string.",
                "string.empty": "Provider Name is not allowed to be empty.",
                "any.required": "Provider Name is not allowed to be empty.",
              }),
              providerPhone: Joi.string().required().messages({
                "string.base": "Provider Phone should be a string.",
                "string.empty": "Provider Phone is not allowed to be empty.",
                "any.required": "Provider Phone is not allowed to be empty.",
              }),
  ...
  const handleRegisteredPatientChange = (selectedPatientId) => {
    if (selectedPatientId === "0") {
      formik.setValues({
        ...
        patientEmail: "",
        patientDateOfBirth: "",
        registeredPatientId: selectedPatientId.id,
      });
  ...
  const handleRegisteredPharmacyChange = (selectedPharmacyId) => {
    if (selectedPharmacyId === "0") {
      ...
      formik.setValues({
        ...
        pharmacyName: "",
        pharmacyPhone: "",
        registeredPharmacyId: selectedPharmacyId,
      });
                  ...
                  <div className="form-group">
                    ...
                    <div className="controls">
                      <select
                        ...
                        className="form-select"
                      >
                        <option value="">Select Sigs</option>
                        {sigs &&
                          sigs.map((sig) => (
