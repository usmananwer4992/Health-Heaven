...
const schema = Joi.object({
  category: Joi.string().required().min(3).max(50).label("Category").messages({
    "string.base": "Sigs is not allowed to be empty.",
    "string.min": "Sigs name should be of alteast 3 characters.",
    "string.max": "Sigs name should not exceed more than 50 characters",
    "string.empty": "Sigs name is not allowed to be empty.",
    "any.required": "Sigs name is not allowed to be empty.",
  }),
});
          ...
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">
                {isEditMode ? "Edit Sigs" : "Add New Sigs"}
              </h5>
              <button
                type="button"
                className="btn-close"
