...
const Transfer = () => {
  ...
  const partners = useSelector((state) => state.transfers.partners);
  ...
  React.useEffect(() => {
    ...
    if (typeof id !== "undefined") {
      dispatch(fetchTransferDetail(id));
    }
  }, [dispatch, id]);
  // React.useEffect(() => {
  ...
  const handleFormSubmit = async (formData) => {
    if (id) {
      try {
        ...
        history.push("/app/admin/transfers");
      } catch (error) {
                ...
                <nav>
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">
                      <Link to="/app/admin/transfers">Transfers</Link>
                    </li>
                  </ol>
                </nav>
              </div>
                  ...
                  {true &&
                    ...
                    (isEditMode || typeof id === "undefined" ? (
                      <TransferForm
                        ...
                        id={id}
                        partners={getPrerequisite && getPrerequisite.partners}
